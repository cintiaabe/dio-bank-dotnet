...
namespace DIO.Bank
{
    class Program
    {
        ...
        private static void InserirConta()
        {
            ...
            Conta novaConta = new Conta(tipoConta: (TipoConta)entradaTipoConta,saldo: saldoInicial,credito: limiteCredito, nome:nomeCliente);
        ...
        {
            Console.WriteLine();
            Console.WriteLine("Banco Teste a seu dispor !!");
